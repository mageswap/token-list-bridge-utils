    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 11:
          ...
          arbProvider = new providers.JsonRpcProvider(l2Network.rpcURL);
          ethProvider = new providers.JsonRpcProvider(l1Network.rpcURL);
          _context.next = 16;
...
var url = 'https://open-api.polygon.technology/api/v1/info/all-mappings';
...
var web3 = /*#__PURE__*/new Web3();
// chains we support fetching mappings for (can be different than the l2ChainIds arg for buildList)
var SUPPORTED_L2_CHAINS = [ChainId.ARBITRUM_ONE, ChainId.POLYGON, ChainId.OPTIMISM, ChainId.BNB];
...
function _getChildTokenDetails() {
  _getChildTokenDetails = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(l1Token, chainId, chainIdToMappingsMap) {
    var _l1Token$extensions, _l1Token$extensions$b, _l1Token$extensions$b2;
    var existingMapping, childToken, childTokenAddress, childTokenValid, decimals;
    return _regeneratorRuntime().wrap(function _callee5$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        case 0:
          existingMapping = l1Token == null ? void 0 : (_l1Token$extensions = l1Token.extensions) == null ? void 0 : (_l1Token$extensions$b = _l1Token$extensions.bridgeInfo) == null ? void 0 : (_l1Token$extensions$b2 = _l1Token$extensions$b[chainId]) == null ? void 0 : _l1Token$extensions$b2.tokenAddress; // use the externally fetched mappings if manual entry doesn't exist for the token/chain mapping
        ...
        case 10:
          ...
          decimals = childToken && chainId === ChainId.BNB ? childToken.decimals : undefined;
...
function verifyExtensions(tokenList) {
  var _loop = function _loop() {
    ...
    if (!((_token$extensions = token.extensions) != null && _token$extensions.bridgeInfo)) return "continue";
    ...
    var _loop2 = function _loop2() {
      ...
      var destTokens = tokenList.tokens.filter(function (t) {
        return t.chainId === Number(destChainId) && t.address ===
...
function _chainify() {
  _chainify = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(l1TokenListOrPathOrUrl) {
    var l1TokenList, l2Chains, chainified;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
        ...
        case 2:
          ...
          l2Chains = [ChainId.POLYGON, ChainId.ARBITRUM_ONE, ChainId.OPTIMISM, ChainId.CELO, ChainId.BNB];
          _context.next = 6;
          return chainifyTokenList(l2Chains, l1TokenListOrPathOrUrl);
        case 6:
          chainified = _context.sent;
          return _context.abrupt("return", mergeTokenLists(l1TokenList,
          // providing l1 first to make sure duplicated tokens resolve to this list
          chainified));
        case 8:
        case "end":
          return _context.stop();
